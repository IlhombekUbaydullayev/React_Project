            ...
            <Row>
                <Col md={8}>
                    <Card>
                        ...
                        <Card.Body>
                            {
                                this.state.nameIs ? <input type="text" className={'form-control'} placeholder={'name'}
                                                           onKeyUp={this.name}/> :
                                    <input type="text" className={'form-control'} placeholder={'name'}
                                           onKeyUp={this.name}/>
                            }
                            <input type="number" className={'form-control mt-2'} placeholder={'protsessor'} onKeyUp={this.protsessor}/>
                            <input type="number" className={'form-control mt-2'} placeholder={'ram'} onKeyUp={this.ram}/>
                            {/*<input type="text" className={'form-control mt-2'} placeholder={'ssd'}/>*/}
                        ...
                        <Card.Footer>
                            <Button variant={'success'} onClick={()=>this.props.saveList(name,protsessor,ram,ssd)}>save</Button>
